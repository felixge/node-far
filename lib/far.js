...
Far.prototype.add = function(path) {
  this._files.push(path);
};

Far.prototype.exclude = function(regex) {
  this._exclude.push(regex);
};

Far.prototype.include = function(regex) {
...
Far.prototype.execute = function() {
  ...
  this._files = paths.expandSync(this._files);
  this._files = this._filter(this._files);

  this._intervalTimer = setInterval(this._printStatus.bind(this), this._interval);
  this._determineBasePath();
  this._executeNext();
};

Far.prototype._filter = function(files) {
...
Far.prototype._determineBasePath = function() {
  var basePath = '';
...
Far.prototype._getProgress = function() {
  return ((this._index + 1) * 100 / this._files.length).toFixed(1) + '%';
};
...
Far.prototype._getCurrentFile = function() {
  return this._files[this._index].substr(this._basePath.length + 1);
};
